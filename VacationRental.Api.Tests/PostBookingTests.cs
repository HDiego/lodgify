...
namespace VacationRental.Api.Tests
{
    ...
    public class PostBookingTests
    {
        ...
        [Fact]
        public async Task GivenCompleteRequest_WhenPostBooking_ThenAPostReturnsErrorWhenThereIsOverbookingWithPreparationDays()
        {
            var postRentalRequest = new RentalBindingModel
            {
                Units = 1,
        ...
        [Fact]
        public async Task GivenCompleteRequest_WhenPostBooking_ThenAPostReturnsOkWhenThereIsBookingWithPreparationDays()
        {
            var postRentalRequest = new RentalBindingModel
            {
                Units = 1,
